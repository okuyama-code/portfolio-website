  ...
  return (
    ...
    >
      ...
      <p className="italic text-2xl">
        コーディングをしていないときは、主に筋トレ、ゴルフ、ママさんバレーに参加したりして体を鍛えています。ゴルフはツアープロに教わりながらコツコツ練習しています。趣味で将棋をさしたりもしています(現在将棋ウォーズ3級)。プログラミング上達のために英語の学習もしています(TOEIC HUNTERというロードマップを購入して学習しています)。
      </p>
    </motion.section>
  );
}
